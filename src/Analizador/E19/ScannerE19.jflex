...
<YYINITIAL>"azul" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
<YYINITIAL>"verde" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
<YYINITIAL>"rojo" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
<YYINITIAL>"rosa" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
<YYINITIAL>"morado" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
<YYINITIAL>"blanco" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
<YYINITIAL>"negro" {return new Symbol(sym.color,yycolumn,yyline,yytext());}
